...
class Launch {
    ...
    async start() {
        ...
        let java = this.options.java ? minecraftJava.path : 'java';
        let minecraftDebug = (0, child_process_1.spawn)(java, Arguments, { cwd: this.options.path, detached: this.options.detached });
    ...
    async DownloadGame() {
        ...
        let gameJava = this.options.java ? await new Minecraft_Java_js_1.default(this.options).GetJsonJava(json) : { files: [] };
